                          ...
                          <table class="table table-striped table-advance table-hover">
                              ...
                              <td><?php echo $cnt;?></td>
                                  ...
                                  <td>
                                     ...
                                     <a href="update-profile.php?uid=<?php echo $row['id'];?>"> 
                                     <button class="btn btn-primary btn-xs">Approve</button></a>
                                     
                                     <a href="manage-users.php?id=<?php echo $row['id'];?>"> 
                                     <button class="btn btn-danger btn-xs" onClick="return confirm('Do you really want to reject the user');">Reject</button></a>
                                  </td>
                              </tr>
                              <?php $cnt=$cnt+1; }?>
